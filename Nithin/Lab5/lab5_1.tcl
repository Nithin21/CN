...
$ns duplex-link $n(3) $n(2) 2Mb 4ms DropTail
...
proc finish {} {
	...
	puts "Througput of TCP is [expr $tcpsize * $tcpnum / $time_of_exec] bytes per sec |n"
	puts "Througput of TCP is [expr $udpsize * $udpnum / $time_of_exec] bytes per sec |n"
	exit 0
	}
